...
bool c_vfunc_hook::setup(void* base /*= nullptr*/)
{
	if (base != nullptr)
		class_base = base;
...
std::size_t c_vfunc_hook::estimate_vftbl_length(std::uintptr_t* vftbl_start)
{
	auto len = std::size_t{};
